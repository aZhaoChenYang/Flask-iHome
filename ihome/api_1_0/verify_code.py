...
# GET /api/v1.0/sms_codes/<moble>?image_code=xxxxx&image_code_id=xxxx
...
def get_sms_code(mobile):
    ...
    # 判断对于这个手机号的操作, 在60s内有没有之前的操作, 如果有, 则认为用户操作频繁, 不接受处理
    try:
        ...
        if send_flag is not None:
            # 表示在60s之前有过发送的记录
            return jsonify(msgno = RET.REQERR, errmsg = "请求过于频繁, 请60s后重试")
